...
const mapAssessmentElements = require('./filters/map-assessment-elements.js')
...
module.exports = events => {
  ...
  .map(event => {
    ...
    const assessment_elements = mapAssessmentElements(event.content.assessment_elements)
    ...
    return {
      ...
      assessment_elements: assessment_elements
    }
  })
    .reverse()
}
